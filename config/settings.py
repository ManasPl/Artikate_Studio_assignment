...
# Database
# Defaults match docker-compose service names/credentials; override via env
# vars for local (non-docker) development.
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "checkouts.exceptions.custom_exception_handler",
}
